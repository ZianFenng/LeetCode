# O(n) solution to this problem, reference as below
# The difference between this problem and the one in the reference
# is that the start point here should be nums[0] since the
# range of number is from 1 to n - 1
